...
import "./BlogCard.css"; // Import CSS file

const BlogCard = ({ title, content, date, author, image , likes , comments , views }) => {
  return (
  <div className="main">
    <div className="card">
    ...
    <div className="data">
      {/* <div className="img">
        ...
        >
          <g strokeLinecap="butt" fill="none" strokeWidth={2.0}>
            <path
              d="M 14.06 0.00
  ...
  Z"
      ...
      <div className="text">
        ...
        <div className="text_s">{content}</div>
      </div>
    </div>
    <div className="btns">
      <div className="likes">
